...
const Layout = () => {
  ...
  const audioSrc = "https://github.com/patrickangeli/simples-site-facil/blob/main/src/components/Winter%20(L'Inverno)%20Op.8%20No.4%20F%20Minor%20Allegro%20Non%20Molto.flac#t=40";
